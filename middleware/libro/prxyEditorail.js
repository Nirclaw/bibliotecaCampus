...
import { buscareditorial } from "../../controller/dtolibro.js";
const proxybuscareditorial = express();

proxybuscareditorial.use(async (req, res, next) => {
  ...
  if (
    ...
    try {
      req.body = coppia;
      let data = plainToClass(buscareditorial, req.body.nombre, {
...
export default proxybuscareditorial;