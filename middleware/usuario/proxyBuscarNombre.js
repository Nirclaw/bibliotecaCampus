...
import { buscarCategoria } from "../../controller/dtoUsuario.js";
const proxybuscarCategoria = express();

proxybuscarCategoria.use(async (req, res, next) => {
  ...
  if (
    ...
    try {
      req.body = coppia;
      let data = plainToClass(buscarCategoria, req.body.nombre, {
...
export default proxybuscarCategoria;